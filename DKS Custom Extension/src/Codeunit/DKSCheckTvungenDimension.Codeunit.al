Codeunit 51004 "DKS Check Tvungen Dimension"
{
    ...
    var
        CalledFromTable_Global: Integer;
    ...
    begin
        ...
        if DKSDimensionenforcement.IsEmpty then
            exit
        else begin
    ...
    begin
        ...
        if SalesHeader.FindFirst then begin
            ...
            if SalesLine.FindSet then
                repeat
                    FindDimensionSet(SalesLine."Dimension Set ID", Format(SalesLine."Document Type"), Format(SalesLine."Line No."));
    ...
    begin
        ...
        if PurchaseHeader.FindFirst then begin
            ...
            if PurchaseLine.FindSet then
                repeat
                    FindDimensionSet(PurchaseLine."Dimension Set ID", Format(PurchaseLine."Document Type"), Format(PurchaseLine."Line No."));
    ...
    begin
        repeat
            if Dimensionenforcement.Get(DimensionSetEntry."Dimension Code", DimensionSetEntry."Dimension Value Code") then begin
